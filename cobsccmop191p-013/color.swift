...
struct Colors {
    ...
    static let babu        = UIColor(red: 0.0/255.0, green: 166.0/255.0, blue: 153.0/255.0, alpha: 1.0)
    static let foggy        = UIColor(red: 118.0/255.0, green: 118.0/255.0, blue: 118.0/255.0, alpha: 1.0)
    static let rausch        = UIColor(red: 255.0/255.0, green: 90.0/255.0, blue: 95.0/255.0, alpha: 1.0)
}
